...
class View extends \Kotchasan\KBase
{
    ...
    public function index()
    {
        ...
        $data2 .= 'header.header .td,.topmenu>ul>li,body.mainpage .footer,.language-menu li>a:hover,.topmenu>ul ul>li.hover>a,.topmenu>ul ul>li:hover>a,.gdpanel a:hover{color:'.self::$cfg->color.'}';
